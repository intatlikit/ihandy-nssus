...
sealed class NetworkResult<out T> {
    ...
    data class Success200<out T>(val data: T?, val statusCode: String) : NetworkResult<T>()
    data class Success204<out T>(val data: T?, val statusCode: String) : NetworkResult<T>()
